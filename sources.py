...
SOURCES = [
    ...
    {"name": "Google News", "q": "\"Capture One\" (photo OR software OR RAW OR tethering OR update)", "kind": "gnews", "cat_hint": "comp"},
    ...
    {"name": "Google News", "q": "\"Photos app\" (iOS OR iPhone) (\"Clean Up\" OR editing OR AI) -\"release date\"", "kind": "gnews", "cat_hint": "comp"},
